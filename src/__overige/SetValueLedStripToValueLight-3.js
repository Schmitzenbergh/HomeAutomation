...
const iTickrateDefault = 333;
const iTickrateLimit = 30000;
...
function WaitForUpdate(){
	if (scriptLock == true){ 
		...
		//setInterval(initWaitForUpdate, 1500);
...
function initWaitForUpdate(){
	...
	if ( bRgbDiffStatus == false) {
		...
		tickrateDecrease(1000);
		tickrateDecrease(1000);
		tickrateDecrease(500);
		tickrateDecrease(250);
		tickrateDecrease(125);
		tickrateDecrease(10);

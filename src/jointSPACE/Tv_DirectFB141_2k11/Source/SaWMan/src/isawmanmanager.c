                                 ...
                                 SaWManWindowConfig       *config )
{
     ...
     /*
       not yet implemented:
       SWMCF_KEY_SELECTION, SWMCF_ASSOCIATION, CWCF_STACKING
     */

     if (flags & ~(SWMCF_ALL - SWMCF_KEY_SELECTION - SWMCF_ASSOCIATION - SWMCF_CURSOR_FLAGS - SWMCF_CURSOR_RESOLUTION - CWCF_STACKING))
          return DFB_INVARG;

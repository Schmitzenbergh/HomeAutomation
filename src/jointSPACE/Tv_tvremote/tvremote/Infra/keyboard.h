...
/* Bit mask for mouse button */
#define TOUCH_SWIPE_UNDEFINED   0x00
#define TOUCH_SWIPE_DOWN        0x01
#define TOUCH_SWIPE_UP          0x02
#define TOUCH_SWIPE_LEFT        0x03
#define TOUCH_SWIPE_RIGHT       0x04
#define TOUCH_SWIPE_TOUCH       0x05
...
extern int  key_OnKeyTimer(void);

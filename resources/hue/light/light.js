...
exports.saveInfo = function(iLightNumber){
  ...
  if ( sArrayLightManufacturerName[iLightNumber] !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/manufacturername",       sArrayLightManufacturerName[iLightNumber] , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /manufacturername     " + sArrayLightManufacturerName[iLightNumber]        ); }); };
  if ( sArrayLightProductname[iLightNumber]      !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/productname",            sArrayLightProductname[iLightNumber]      , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /productname          " + sArrayLightProductname[iLightNumber]             ); }); };
  if ( sArrayLightModelid[iLightNumber]          !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/modelid",                sArrayLightModelid[iLightNumber]          , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /modelid              " + sArrayLightModelid[iLightNumber]                 ); }); };
  if ( sArrayLightName[iLightNumber]             !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/name",                   sArrayLightName[iLightNumber]             , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /name                 " + sArrayLightName[iLightNumber]                    ); }); };
  if ( sArrayLightSwversion[iLightNumber]        !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/swversion",              sArrayLightSwversion[iLightNumber]        , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /swversion            " + sArrayLightSwversion[iLightNumber]               ); }); };
  if ( sArrayLightType[iLightNumber]             !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/type",                   sArrayLightType[iLightNumber]             , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /type                 " + sArrayLightType[iLightNumber]                    ); }); };
  if ( sArrayLightUniqueid[iLightNumber]         !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/uniqueid",               sArrayLightUniqueid[iLightNumber]         , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /uniqueid             " + sArrayLightUniqueid[iLightNumber]                ); }); };
  if ( bArrayLightOn[iLightNumber]               !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/on",               bArrayLightOn[iLightNumber]               , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/on             " + bArrayLightOn[iLightNumber]                      ); }); };
  if ( iArrayLightBriCur[iLightNumber]           !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/bri",              iArrayLightBriCur[iLightNumber]           , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/bri            " + iArrayLightBriCur[iLightNumber]                  ); }); };
  if ( iArrayLightHueCur[iLightNumber]           !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/hue",              iArrayLightHueCur[iLightNumber]           , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/hue            " + iArrayLightHueCur[iLightNumber]                  ); }); };
  if ( iArrayLightSatCur[iLightNumber]           !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/sat",              iArrayLightSatCur[iLightNumber]           , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/sat            " + iArrayLightSatCur[iLightNumber]                  ); }); };
  if ( sArrayLightEffect[iLightNumber]           !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/effect",           sArrayLightEffect[iLightNumber]           , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/effect         " + sArrayLightEffect[iLightNumber]                  ); }); };
  if ( fArrayLightXyCur[iLightNumber]            !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/xy",               fArrayLightXyCur[iLightNumber]            , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/xy             " + fArrayLightXyCur[iLightNumber]                   ); }); };
  if ( fArrayLightXyXCur[iLightNumber]           !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/x",                fArrayLightXyXCur[iLightNumber]           , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/xy/x           " + fArrayLightXyXCur[iLightNumber]                  ); }); };
  if ( fArrayLightXyYCur[iLightNumber]           !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/y",                fArrayLightXyYCur[iLightNumber]           , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/xy/y           " + fArrayLightXyYCur[iLightNumber]                  ); }); };
  if ( iArrayLightCtCur[iLightNumber]            !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/ct",               iArrayLightCtCur[iLightNumber]            , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/ct             " + iArrayLightCtCur[iLightNumber]                   ); }); };
  if ( sArrayLightAlert[iLightNumber]            !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/alert",            sArrayLightAlert[iLightNumber]            , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/alert          " + sArrayLightAlert[iLightNumber]                   ); }); };
  if ( sArrayLightColorMode[iLightNumber]        !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/colormode",        sArrayLightColorMode[iLightNumber]        , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/colormode      " + sArrayLightColorMode[iLightNumber]               ); }); };
  if ( bArrayLightReachable[iLightNumber]        !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/reachable",        bArrayLightReachable[iLightNumber]        , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/reachable      " + bArrayLightReachable[iLightNumber]               ); }); };
  if ( iArrayLightTransitionTime[iLightNumber]   !== undefined ){ fs.writeFile( pathhuelightvalues + iLightNumber + "/state/transitiontime",   iArrayLightTransitionTime[iLightNumber]   , function(err) { if(err) { return console.log(err); } console.log("Saved Light " + iLightNumber + " - /state/transitiontime " + iArrayLightTransitionTime[iLightNumber]          ); }); };

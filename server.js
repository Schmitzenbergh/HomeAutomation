...
var io = require('socket.io').listen(server);
  ...
  io.sockets.on('connection', function(socket){
      ...
      socket.on('pushBufferobjAmbilightCached'        , function(data){ tv.pushBufferobjAmbilightCached()        ; });
      socket.on('pushBufferobjAmbiLightLounge'        , function(data){ tv.pushBufferobjAmbiLightLounge()        ; });
      socket.on('pushBufferobjAmbiLightMode'          , function(data){ tv.pushBufferobjAmbiLightMode()          ; });
      socket.on('pushBufferobjAudioVolume'            , function(data){ tv.pushBufferobjAudioVolume()            ; });
      socket.on('pushBufferobjInputPointer'           , function(data){ tv.pushBufferobjInputPointer()           ; });


      socket.on('pushBufferobjInputKeyStandby'        , function(data){ tv.pushBufferobjInputKeyStandby()        ; });
      socket.on('pushBufferobjInputKeyBack'           , function(data){ tv.pushBufferobjInputKeyBack()           ; });
      socket.on('pushBufferobjInputKeyFind'           , function(data){ tv.pushBufferobjInputKeyFind()           ; });
      socket.on('pushBufferobjInputKeyRedColour'      , function(data){ tv.pushBufferobjInputKeyRedColour()      ; });
      socket.on('pushBufferobjInputKeyGreenColour'    , function(data){ tv.pushBufferobjInputKeyGreenColour()    ; });
      socket.on('pushBufferobjInputKeyYellowColour'   , function(data){ tv.pushBufferobjInputKeyYellowColour()   ; });
      socket.on('pushBufferobjInputKeyBlueColour'     , function(data){ tv.pushBufferobjInputKeyBlueColour()     ; });
      socket.on('pushBufferobjInputKeyHome'           , function(data){ tv.pushBufferobjInputKeyHome()           ; });
      socket.on('pushBufferobjInputKeyVolumeUp'       , function(data){ tv.pushBufferobjInputKeyVolumeUp()       ; });
      socket.on('pushBufferobjInputKeyVolumeDown'     , function(data){ tv.pushBufferobjInputKeyVolumeDown()     ; });
      socket.on('pushBufferobjInputKeyMute'           , function(data){ tv.pushBufferobjInputKeyMute()           ; });
      socket.on('pushBufferobjInputKeyOptions'        , function(data){ tv.pushBufferobjInputKeyOptions()        ; });
      socket.on('pushBufferobjInputKeyDot'            , function(data){ tv.pushBufferobjInputKeyDot()            ; });
      socket.on('pushBufferobjInputKeyDigit0'         , function(data){ tv.pushBufferobjInputKeyDigit0()         ; });
      socket.on('pushBufferobjInputKeyDigit1'         , function(data){ tv.pushBufferobjInputKeyDigit1()         ; });
      socket.on('pushBufferobjInputKeyDigit2'         , function(data){ tv.pushBufferobjInputKeyDigit2()         ; });
      socket.on('pushBufferobjInputKeyDigit3'         , function(data){ tv.pushBufferobjInputKeyDigit3()         ; });
      socket.on('pushBufferobjInputKeyDigit4'         , function(data){ tv.pushBufferobjInputKeyDigit4()         ; });
      socket.on('pushBufferobjInputKeyDigit5'         , function(data){ tv.pushBufferobjInputKeyDigit5()         ; });
      socket.on('pushBufferobjInputKeyDigit6'         , function(data){ tv.pushBufferobjInputKeyDigit6()         ; });
      socket.on('pushBufferobjInputKeyDigit7'         , function(data){ tv.pushBufferobjInputKeyDigit7()         ; });
      socket.on('pushBufferobjInputKeyDigit8'         , function(data){ tv.pushBufferobjInputKeyDigit8()         ; });
      socket.on('pushBufferobjInputKeyDigit9'         , function(data){ tv.pushBufferobjInputKeyDigit9()         ; });
      socket.on('pushBufferobjInputKeyInfo'           , function(data){ tv.pushBufferobjInputKeyInfo()           ; });
      socket.on('pushBufferobjInputKeyCursorUp'       , function(data){ tv.pushBufferobjInputKeyCursorUp()       ; });
      socket.on('pushBufferobjInputKeyCursorDown'     , function(data){ tv.pushBufferobjInputKeyCursorDown()     ; });
      socket.on('pushBufferobjInputKeyCursorLeft'     , function(data){ tv.pushBufferobjInputKeyCursorLeft()     ; });
      socket.on('pushBufferobjInputKeyCursorRight'    , function(data){ tv.pushBufferobjInputKeyCursorRight()    ; });
      socket.on('pushBufferobjInputKeyConfirm'        , function(data){ tv.pushBufferobjInputKeyConfirm()        ; });
      socket.on('pushBufferobjInputKeyNext'           , function(data){ tv.pushBufferobjInputKeyNext()           ; });
      socket.on('pushBufferobjInputKeyPrevious'       , function(data){ tv.pushBufferobjInputKeyPrevious()       ; });
      socket.on('pushBufferobjInputKeyAdjust'         , function(data){ tv.pushBufferobjInputKeyAdjust()         ; });
      socket.on('pushBufferobjInputKeyWatchTV'        , function(data){ tv.pushBufferobjInputKeyWatchTV()        ; });
      socket.on('pushBufferobjInputKeyViewmode'       , function(data){ tv.pushBufferobjInputKeyViewmode()       ; });
      socket.on('pushBufferobjInputKeyTeletext'       , function(data){ tv.pushBufferobjInputKeyTeletext()       ; });
      socket.on('pushBufferobjInputKeySubtitle'       , function(data){ tv.pushBufferobjInputKeySubtitle()       ; });
      socket.on('pushBufferobjInputKeyChannelStepUp'  , function(data){ tv.pushBufferobjInputKeyChannelStepUp()  ; });
      socket.on('pushBufferobjInputKeyChannelStepDown', function(data){ tv.pushBufferobjInputKeyChannelStepDown(); });
      socket.on('pushBufferobjInputKeySource'         , function(data){ tv.pushBufferobjInputKeySource()         ; });
      socket.on('pushBufferobjInputKeyAmbilightOnOff' , function(data){ tv.pushBufferobjInputKeyAmbilightOnOff (); });
      socket.on('pushBufferobjInputKeyPlayPause'      , function(data){ tv.pushBufferobjInputKeyPlayPause()      ; });
      socket.on('pushBufferobjInputKeyPause'          , function(data){ tv.pushBufferobjInputKeyPause()          ; });
      socket.on('pushBufferobjInputKeyFastForward'    , function(data){ tv.pushBufferobjInputKeyFastForward()    ; });
      socket.on('pushBufferobjInputKeyStop'           , function(data){ tv.pushBufferobjInputKeyStop()           ; });
      socket.on('pushBufferobjInputKeyRewind'         , function(data){ tv.pushBufferobjInputKeyRewind()         ; });
      socket.on('pushBufferobjInputKeyRecord'         , function(data){ tv.pushBufferobjInputKeyRecord()         ; });
      socket.on('pushBufferobjInputKeyOnline'         , function(data){ tv.pushBufferobjInputKeyOnline()         ; });

      socket.on('pushBufferobjPowerstateOn'           , function(data){ tv.pushBufferobjPowerstateOn()           ; });
      socket.on('pushBufferobjPowerstateStandby'      , function(data){ tv.pushBufferobjPowerstateStandby()      ; });
